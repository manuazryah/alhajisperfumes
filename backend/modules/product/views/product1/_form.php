            ...
            <div class="row" style="margin: 0 auto; padding: 15px 15px;">
                ...
                <div class='col-md-4 col-sm-6 col-xs-12 '>
                    ...
                    if (!$model->isNewRecord) {
                        $cat = Category::find()->where(['main_category' => $model->main_category, 'status' => '1'])->orderBy(['category' => SORT_ASC])->all();
                        echo $form->field($model, 'category')->dropDownList(ArrayHelper::map($cat, 'id', 'category'), ['prompt' => 'select']);
                    } else {
                        ?>
                        <?=
                        $form->field($model, 'category')->dropDownList(ArrayHelper::map(Category::find()->where(['main_category' => '1'])->orderBy(['category' => SORT_ASC])->all(), 'id', 'category'), ['prompt' => 'select']);
                    }
                    ?>
