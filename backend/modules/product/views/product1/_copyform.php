        ...
        <div class="tab-pane active" id="general">
            <div class="row" style="margin: 0 auto; padding: 15px 15px;">
                <div class='col-md-12 col-sm-6 col-xs-12 '>
                    <?= $form->field($model, 'main_category')->dropDownList(ArrayHelper::map(common\models\MainCategory::find()->all(), 'id', 'main_category'), ['prompt' => 'select']) ?>
                </div>
                ...
                <div class='col-md-4 col-sm-6 col-xs-12 '>
                    <?= $form->field($model, 'price')->textInput(['type' => 'number', 'min' => '0', 'autocomplete' => 'off'])->label('Price'); ?>
                </div>
                <div class='col-md-4 col-sm-6 col-xs-12 '>
                ...
                <div class='col-md-6 col-sm-6 col-xs-12 '>
                    <?= $form->field($model, 'profile')->fileInput()->label('profile Picture<i> (600*600)</i>') ?>
                    <?php
                    if (!$model->isNewRecord) {
                ...
                <div class='col-md-6 col-sm-6 col-xs-12 '>
                    <?= $form->field($model, 'other_image[]')->fileInput(['multiple' => true, 'accept' => 'image/*'])->label('Gallery Images<i> (600*600)</i>') ?>
