                ...
                <div class="fright">
                    ...
                    <div class="button-section "> 
                        <?php if (empty(Yii::$app->user->identity)) { ?>
                            <?= Html::a('Login to Checkout', ['/site/login-signup', 'go' => Yii::$app->request->hostInfo . Yii::$app->request->url], ['class' => 'check-utton', 'id' => 'loginCheckout']) ?>
                            <?php
                        } else {
                            if ($cart_item_count > 0) {
                                ?>
                                <?= Html::a('check out', ['/cart/proceed'], ['class' => 'check-utton']) ?>     
                            <?php } else { ?>
